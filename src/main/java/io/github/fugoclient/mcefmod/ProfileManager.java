...
public class ProfileManager {
    ...
    public Profile authenticateMicrosoft(String code) throws Exception {
        // 1. Get Access Token from Microsoft OAuth
        ...
        // 4. Authenticate with Mojang (Login with Xbox)
        ...
        // 5. Retrieve Minecraft Profile details (UUID & Username)
